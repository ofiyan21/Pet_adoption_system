...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          <li><a href="#hero" onclick="changePageHome()">Home</a></li>
          <li><a href="#about" onclick="changePageAbout()">About</a></li>
          <li><a href="#menu" onclick="changePageAdopt()">Adoption</a></li>
 ...
 <script type="text/javascript">
        function changePageAbout() {
            newPageTitle = 'Adopt-Here | About';
            document.title = newPageTitle;
        }
        function changePageAdopt() {
            newPageTitle = 'Adopt-Here | Pets';
            document.title = newPageTitle;
        }
        function changePageHome() {
            newPageTitle = 'Adopt-Here';
            document.title = newPageTitle;
        }
    </script>
